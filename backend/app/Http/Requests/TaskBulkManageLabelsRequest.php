...
class TaskBulkManageLabelsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'label_ids' => 'required|array|min:1|max:20',
    ...
    public function messages(): array
    {
        return [
            ...
            'label_ids.min' => 'At least one label ID is required',
            'label_ids.max' => 'Cannot process more than 20 labels at once',
