...
export class WorkspaceListComponent implements OnInit {
  ...
  createWorkspace(): void {
    this.router.navigate(['/manage/workspaces/create']);
  }

  editWorkspace(workspace: IWorkspace): void {
    this.openMenuId = null;
    this.router.navigate(['/manage/workspaces', workspace.id, 'edit']);
  }

  navigateToMembers(workspace: IWorkspace): void {
    this.openMenuId = null;
    this.workspaceContextService.setCurrentWorkspace(workspace);
    this.router.navigate(['/manage/workspaces'], { queryParams: { tab: 'members' } });
  }
