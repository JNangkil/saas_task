import { Component, Input, Output, EventEmitter, OnInit, OnDestroy, OnChanges, ChangeDetectionStrategy, HostBinding, SimpleChanges } from '@angular/core';
...
export class TaskDetailsPanelComponent implements OnInit, OnDestroy, OnChanges {
    // Inputs
    @Input() task!: Task;
    @Input() visible = true;
    ...
    @HostBinding('class.docked') get dockedClass() {
        return this.docked;
    }
