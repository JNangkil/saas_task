...
export class AdminDashboardComponent implements OnInit {
    ...
    quickActions = [
        { icon: 'add', label: 'Create Workspace', route: '/manage/workspaces/create', color: 'primary' },
        { icon: 'person_add', label: 'Invite Member', route: '/users', color: 'accent' },
        { icon: 'settings', label: 'Team Settings', route: '/manage/settings', color: 'secondary' },
        { icon: 'analytics', label: 'View Analytics', route: '/manage/workspaces', color: 'info' }
    ];
