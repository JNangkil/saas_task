...
const Highlights = ({ limit }: IHighlightsProps) => {
  const rows: IHighlightsRows = [
    ...
    { icon: RiBankLine, text: 'Webhooks', total: 7, stats: 0.7, increase: false },
  ];

  const items: IHighlightsItems = [
    { badgeColor: 'bg-green-500', label: 'Enterprise' },
    { badgeColor: 'bg-destructive', label: 'Pro' },
    { badgeColor: 'bg-violet-500', label: 'Free' },
  ];
      ...
      <CardContent className="flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
        <div className="flex flex-col gap-0.5">
          ...
          <div className="flex items-center gap-2.5">
            <span className="text-3xl font-semibold text-mono">1.2M</span>
