...
const CommunityBadges = ({ title }: ICommunityBadgesProps) => {
  ...
  return (
    <Card>
      ...
      <CardContent className="pb-7.5 p-5 pt-0">
...
export {
  CommunityBadges as Integrations,
  type ICommunityBadgesItem as IIntegrationsItem,
  type ICommunityBadgesItems as IIntegrationsItems,
  type ICommunityBadgesProps as IIntegrationsProps,
};
