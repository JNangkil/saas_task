...
export function SignInPage() {
  ...
  useEffect(() => {
    ...
    if (pwdReset === 'success') {
      ...
      if (LaravelAdapter.isAccountLocked()) {
  ...
  const handleGoogleSignIn = async () => {
    // TODO: Implement OAuth flow when needed
      ...
      >
        ...
        <Alert>
          ...
          <AlertTitle>
            ...
            <strong>password</strong> password for demo access.
          </AlertTitle>
        </Alert>
          ...
          >
            {isGoogleLoading ? (
              <span className="flex items-center gap-2">
                <LoaderCircle className="h-4 w-4 animate-spin" /> Signing in with
                Google...
              </span>
            ) : (
              <>
